package com.vroong.msabootcamp.config.scheduler;
...
class AsyncTaskDecorator implements TaskDecorator {
  ...
  public Runnable decorate(Runnable runnable) {
    ...
    if (contextMap == null) {
       ...
       *   at com.vroong.msabootcamp.config.scheduler.AsyncTaskDecorator.lambda$decorate$0(AsyncTaskDecorator.java:21)"
