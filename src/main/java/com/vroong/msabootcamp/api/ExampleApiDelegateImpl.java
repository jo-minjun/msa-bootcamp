...
import static com.vroong.msabootcamp.api.error.ErrorConstants.CONSTRAINT_VIOLATION_TYPE;
import static java.util.Arrays.asList;

import com.vroong.msabootcamp.api.error.BadRequestAlertException;
import com.vroong.msabootcamp.api.model.ExampleDto;
import com.vroong.msabootcamp.api.model.ExampleListDto;
...
public class ExampleApiDelegateImpl implements ExampleApiDelegate {
   ...
   * {
   *   "type": "msabootcamp/problem-with-message",
   *   "title": "Unauthorized",
   *   "status": 401,
   ...
   * {
   *   "errorKey": "msabootcamp/constraint-violation",
   *   "type": "msabootcamp/problem-with-message",
   *   "title": "Unacceptable type given: Unacceptable",
   *   "status": 400,
   *   "message": "error.msabootcamp/constraint-violation",
   *   "params": null
   * }
   * ```
   *
